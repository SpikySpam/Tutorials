...
# SECURITY
export TF_VAR_PIHOLE_PORT_INT_DNS=53
export TF_VAR_PIHOLE_PORT_EXT_DNS=53
export TF_VAR_PIHOLE_PORT_INT_DHCP=67
export TF_VAR_PIHOLE_PORT_EXT_DHCP=67
export TF_VAR_PIHOLE_PORT_INT_HTTP=80
export TF_VAR_PIHOLE_PORT_EXT_HTTP=87
...
export TF_VAR_HARBOR_PORT_INT_CORE=8080
export TF_VAR_HARBOR_PORT_EXT_CORE=8085
