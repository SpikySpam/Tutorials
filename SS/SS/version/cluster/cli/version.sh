...
export TF_VAR_VERSION_CLI_K9S="0.27.4"        # https://github.com/derailed/k9s/releases
...
export TF_VAR_VERSION_CLI_PODMAN="4.7.0"      # https://github.com/containers/podman/releases
