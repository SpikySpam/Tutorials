...
test -z $PARAM_ENVIRONMENT && PARAM_ENVIRONMENT=$TF_VAR_ENVIRONMENT_DEV
...
export TF_WORKSPACE=$TF_VAR_PROVIDER-$TF_CLUSTERNAME

echo " PREFIX:       " $TF_VAR_PREFIX
echo " PROVIDER:     " $TF_VAR_PROVIDER
echo " ENVIRONMENT:  " $TF_VAR_ENVIRONMENT
echo " REGION:       " $TF_VAR_REGION
echo " DOMAIN:       " $TF_DOMAIN
echo " CLUSTERNAME:  " $TF_CLUSTERNAME
